...
void
deal_k_near_n(int n, int k, int *a) {
...
int
urandint_m(int n, int m, int *out) {
        deal(n, m, out);
        return 0;
}
...
int
wrandint_1(int elem_size, const double *weights) {
        double sum = 0, choice = 0;
        int i = 0;
        ...
        choice = urandint_1(elem_size) * sum;
